...
public interface OutputObserver {
    ...
    /**
     * Concrete OBSERVERs will receive the number of bytes (from some instance that writes bytes for some reason) and do something with this information. The
     * call should return immediately to not block the event-firing process.
     * 
