...
public interface ThroughputListener {
    ...
    /**
     * Notifies the listener about the current state of the {@link ThroughputLimiter}.
     * <p>
     * <b>Note:</b> This method runs synchronously related to the checker thread. On the one hand there cannot be a second call in parallel. On the other hand a
     * blocking or overly long executing listener method impacts the monitoring as it delays the next notification. Thus concrete implementations should run
     * fast.
     * 
