...
public class SecuMangaService extends Service {
     ...
     * logger
     */
    private static final Logger LOGGER = Logger.getLogger(de.calamanari.pk.gateway.client.SecuMangaService.class.getName());
    ...
    static {
        ...
        try {
            ...
            LOGGER.warning("Failed to create URL for the wsdl Location: " + "'http://localhost:8091/SecuMangaWebService?wsdl', retrying as a local file");
